...
d1 $ stack [
  ...
  slow 4 $ every 4 (jux (rev)) $ brak $ n "b5 ~ ~ c5 a5 ~ ~"
    ...
    # gain "0.6"
    # sustain "5 4 3 2"
] # delay 0.25 # delayfeedback 0.19 # delaytime 0.2 # room 0.45 # size 0.45
...
d1 $ stack [
  ...
  slow 4 $ every 4 (jux (rev)) $ n (off 0.25 (+5) "b5 ~ ~ c5 a5 ~ ~")
    ...
    # cutoff (sine1  * 800)
    # resonance 0.15
] # delay 0.5 # delayfeedback 0.5 # delaytime 0.9 # room 0.5 # size 0.5
...
d1 $ stack [
  ...
  slow 4 $ every 4 (jux (rev)) $ n (off 0.25 (+5) "b5 ~ ~ c5 a5 ~ ~")
    ...
    # cutoff (sine1  * 800)
    # resonance 0.15
] # delay 0.5 # delayfeedback 0.5 # delaytime 0.9 # room 0.7 # size 0.5
