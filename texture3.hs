...
d1 $ off (0.25) (# s "pulse") $ n (slow 2 $ off 0.125 (+12) $ off 0.25 (+7) $ slow 2 $ "d7(3,8) a7 [c6(3,8,2) e7*2] e6(3,8)") # sound "rash" # gain "0.75" # cutoff (sine1  * 2000 + 400) # resonance 0.1 # room 0.2 # size 0.2 # orbit 1

-- # play with cutoff 1000, # cutoff (sine1  * 2000) # resonance 0.2
d1 $ jux rev $ off (0.25) (# s "pulse") $ n (slow 2 $ off 0.125 (+12) $ off 0.25 (+7) $ slow 2 $ "d7(3,8) a7 [c6(3,8,2) e7*2] e6(3,8)") # sound "rash" # gain "0.72" # cutoff (sine1  * 3000 + 400) # resonance 0.2 # room 0.2 # size 0.2 # orbit 1

-- ending get bigger the room and size
-- possible ending, play with this
d1 $ degradeBy 0.65 $ jux rev $ off (0.25) (# s "pulse") $ n (slow 2 $ off 0.125 (+12) $ off 0.25 (+7) $ slow 2 $ "d7(3,8) a7 [c6(3,8,2) e7*2] e6(3,8)") # sound "rash" # gain 0.5 # cutoff (sine1  * 2000 + 200) # resonance 0.2 # room 1 # size 0.8 # orbit 1
