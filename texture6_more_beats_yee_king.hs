...
d1 $ sound "amencutup*3" # n (irand 16) # orbit 1
d1 $ someCycles (fast 2) $ sound "amencutup*2" # n (irand 16) # crush 4 # orbit 1
d1 $ slow 2 $ n (run "<4 8 4 6>") # sound "amencutup" # orbit 1
...
d1 $ every 3 (slow 3) $ n (run 8) # s "amencutup" # orbit 1


 -- # crush 4

do
  d2 $ s "fs:1" # gain 0.7 # orbit 1
